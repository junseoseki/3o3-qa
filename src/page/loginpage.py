...
class loginpage(basepage):
    def __init__(self, page, timeout = 7000):
    ...
    def try_login_with_testid(self):
        self.try_login()
        self._get_locator(login_locator.id_input).fill(os.getenv("TESTID"))
        self._get_locator(login_locator.password_input).fill(os.getenv("TESTPASSWORD"))
